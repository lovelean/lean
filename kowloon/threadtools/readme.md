...
|文档版本|更新时间|内容|作者|
|---|---|---|---|
|1.0.1|2017-12-14|创建|王敏力|

## 概述
http客户端调用包，基于最新的httpclient4.5.3开发，针对现有业务需求做封装。包含功能 1、http连接池。2、可配置正向代理。3、可配置忽略https中CA用户证书认证。4、提供form表单和body两种方式请求。
