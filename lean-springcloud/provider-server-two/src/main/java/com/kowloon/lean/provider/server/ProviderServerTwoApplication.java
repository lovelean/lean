...
/**
 * 
 * ClassName：com.kowloon.lean.provider.server.ProviderServerTwoApplication　　<br/>
 * Description：<br/>
 * Date：2019年1月15日 下午4:08:09<br/>
 * @author lean
 * @version 1.0
 */
...
public class ProviderServerTwoApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProviderServerTwoApplication.class, args);
	}
}
