...
/**
 * 
 * ClassName：com.lean.project.springboot.monitor.api.httpclient.HttpClientPoolConfig　　<br/>
 * Description：httpClient链接池参数配置 <br/>
 * Date：2019年1月27日 下午4:19:26<br/>
 * @author lean
 * @version 1.0
 */
public class HttpClientPoolConfig {
	...
	public String toString() {
		return "HttpClientPoolConfig [connectionTimeout=" + connectionTimeout + ", socketTimeout=" + socketTimeout
				+ ", requestConnectionTimeout=" + requestConnectionTimeout + ", poolMaxTotal=" + poolMaxTotal
				+ ", maxPerRoute=" + maxPerRoute + ", isIgnoreSSL=" + isIgnoreSSL + "]";
	}
}
